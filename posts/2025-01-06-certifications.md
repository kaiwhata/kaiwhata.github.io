...
| Practical Web Pentest Professional (PWPP) | TCM Security | USD$499 | Course Complete, Will not sit Cert | Medium | :+1: | I'd consider doing this cert as a stepping stone to the Burp Certification, as they share content but Burp goes WAY deeper. TCMs exams seem decent, so there's a solid chance of passing on your first or second attempt. |
